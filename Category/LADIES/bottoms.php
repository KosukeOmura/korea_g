        ...
        <div id="categories">
            ...
            <div id="categoriesCol">
                <div class="mens">
                    ...
                    <ul>
                        <li class="cm1"><a href="../MENS/tops.php"><img src="../../indexトップページ用/top.images/categories_tops.png"></a></li>
                        <li><a href="../MENS/outer.php"><img src="../../indexトップページ用/top.images/categories_outer.png"></a></li>
                        <li><a href="../MENS/bottoms.php"><img src="../../indexトップページ用/top.images/categories_bottoms.png"></a></li>
                        <li><a href="../MENS/set_up.php"><img src="../../indexトップページ用/top.images/categories_setup.png"></a></li>
                        <li><a href="../MENS/other.php"><img src="../../indexトップページ用/top.images/categories_other.png"></a></li>
                        <li><a href="../MENS/shoes.php"><img src="../../indexトップページ用/top.images/categories_shoes.png"></a></li>
                        <li><a href="../MENS/goods.php"><img src="../../indexトップページ用/top.images/categories_goods.png"></a></li>
                        <li><a href="../MENS/bag.php"><img src="../../indexトップページ用/top.images/categories_bag.png"></a></li>
                    </ul>
                </div>
            </div>
            <div id="categoriesCol2">
                <div class="ladies">
                    ...
                    <ul>
                        <li><a href="tops.php"><img src="../../indexトップページ用/top.images/categories_tops.png"></a></li>
                        <li><a href="outer.php"><img src="../../indexトップページ用/top.images/categories_outer.png"></a></li>
                        <li><a href="bottoms.php"><img src="../../indexトップページ用/top.images/categories_bottoms_ladies.png"></a></li>
